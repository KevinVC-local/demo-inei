...
export class ButtonComponent {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    primary: {
      bold: 'bg-tdpPrimary text-primary-foreground shadow-md hover:bg-tdpPrimary/90 focus-visible:ring-tdpPrimary',
      light: 'bg-tdpPrimary/20 text-primary hover:bg-tdpPrimary/30 focus-visible:ring-tdpPrimary',
      none: 'bg-transparent text-primary hover:bg-primary/10 focus-visible:ring-primary border border-tdpPrimary',
    },
    danger: {
